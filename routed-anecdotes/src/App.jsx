...
import {
  Routes, Route, useParams, Link,  useNavigate,  useMatch
...
return (
  <div>
      ...
      <div>has {anecdote.author} votes</div>
...
const CreateNew = (props) => {
  ...
  <form>
    <div>
      content
      <input name='content'  {...contentForm} />
    </div>
    <div>
      author
      <input name='author'{...authorForm} />
    </div>
    <div>
      url for more info
      <input name='info' {...infoForm}/>
    </div>
    <button onClick={handleSubmit}>create</button>
    <button onClick={()=>{contentForm.onClick(); authorForm.onClick(); infoForm.onClick()}}>reset</button>
  </form>
  </div>)
